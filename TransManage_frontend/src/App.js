...
import Translations from './Components/Dashboard/Projects/Pages/TranslationKeys/Translations/Translations';
import './App.css';
...
function App() {
  ...
  || matchPath('/projects/:id/pages/:pageId/translation-keys/:translation-key-id/translations', location.pathname) !== null;
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/projects/:id/pages/:pageId/translation-keys/:translationKeyId/translations" element={<Translations />} />
